...
<body>
    ...
    <form action="{{ route('editproduct.post') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="file" name="image" value="{{ $data[0]['url'] }}"><br>
            <input type="text" name="pname" value="{{ $data[0]['pname'] }}"><br>
            <input type="text" name="desc" value="{{ $data[0]['desc'] }}"><br>
            <input type="number" name="price" value="{{ $data[0]['price'] }}"><br>
            <input type="number" name="qty" value="{{ $data[0]['qty'] }}"><br>
